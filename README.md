...
Claude Code 사용량(토큰)을 포켓몬 수집 게임으로 바꿔주는 Windows 데스크톱 트레이 앱입니다.
Claude Code 대화 로그를 실시간으로 감시해 토큰 사용량을 누적하고, 사용량이 쌓이면 야생 포켓몬이
...
- **권리자 문의·연락**: pau108203@naver.com 또는 이 저장소의 [Issues](https://github.com/cpu500m/toketmon/issues)에 남겨 주시면 확인 즉시 대응합니다.
